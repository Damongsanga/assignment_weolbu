package com.weolbu.assignment.global.exception.handler;


import com.weolbu.assignment.global.exception.BaseException;
import com.weolbu.assignment.global.exception.errorcode.CommonErrorCode;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleCustomArgument(BaseException e) {
        log.warn("BaseException : {}", e.getMessage());
        log.warn("BaseException : {}", (Object) e.getStackTrace());
